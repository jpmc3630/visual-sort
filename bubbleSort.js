...
var dothis = function()
{
    ...
    // compare two values, if left value is bigger then right value flip their positions.
    ...
    //update array text
    $('#start').html(unsortedArr);
    //update graphic
    drawArray(unsortedArr);
    console.log('hi');

};
var x = setInterval(dothis, t);
...
function drawArray(arr) {
  ...
  for (let i = 0; i < arr.length; i++ ) {
    ...
    let line = $('<div class="line" style="background-color:black; width:2px; float:left; position:absolute">');
    line.css('height', arr[i]);
    line.css('top', (500-arr[i]));
    line.css('left', (2*i))
    $('#start-graph').append(line);
